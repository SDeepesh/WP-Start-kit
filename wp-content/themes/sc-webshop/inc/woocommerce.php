...
/* add_filter( 'woocommerce_enqueue_styles', '__return_empty_array' ); */ // phpcs:ignore
...
function sc_webshop_woocommerce_setup() {
	...
	/* add_theme_support( 'wc-product-gallery-zoom' ); */ // phpcs:ignore
...
function sc_webshop_wc_remove_actions() {
	...
	/* remove_action( 'woocommerce_sidebar', 'woocommerce_get_sidebar', 10 ); */ // phpcs:ignore
...
/**
 * Function that outputs opening wrapper around shop page content.
 *
 * @return void
 */
...
/**
 * Function that outputs closing wrapper around shop page content.
 *
 * @return void
 */
